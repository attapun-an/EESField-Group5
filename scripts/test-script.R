# test script to practice using Hemiphot functions 
# Based on HemiphotTest.R Hans ter Steege (2018)
# attapun-an
# uses images from wikipedia under images/test
...
im <- readJPEG("images/test/Hemiphoto_monarch_habitat1.jpg", native = F)        # this turns into array
im_natve <- readJPEG("images/test/Hemiphoto_monarch_habitat1.jpg", native = T)  # this turns into raster
